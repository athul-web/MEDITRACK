/**
 * Hospitals Page - Full hospital listing with search
 * Per MediTrack UI Spec - dedicated hospitals browsing page
 */
  ...
  return (
    <div className="min-h-screen bg-[var(--color-page)] flex flex-col">
      ...
      <main className="flex-1">
        {/* Search Section - similar to hero but without the headline/image */}
        <section className="bg-[var(--color-brand-light)] pt-[64px] pb-[40px]">
          <div className="container-page">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-[var(--text-section)] font-bold text-[var(--color-text-primary)] mb-2">Find Hospitals</h1>
              <p className="text-[var(--text-body)] text-[var(--color-text-secondary)] mb-8">
                Search for hospitals with specific emergency resources in your area
              </p>
